const { BrunoQuery, QueryOperator, SortDirection } = require('../dist/index.js');

console.log('🧪 Comprehensive BrunoQuery Test Suite (CommonJS)');
console.log('================================================\n');
...
console.log('🎉 All CommonJS tests completed successfully!');
console.log('================================================');
